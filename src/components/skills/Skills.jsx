  ...
  return (
    <section className="skills section" id="skills">
      ...
      <div className="skills__container container grid">
        ...
        <div className="skills__data">
          <div className="skills__titles">
            <h3 className="skills__name">UI/UX Design Principles</h3>
            <span className="skills__number">90%</span>
          </div>
          <div className="skills__bar">
        ...
        <div className="skills__data">
          <div className="skills__titles">
            <h3 className="skills__name">State Management (Provider, Bloc) </h3>
        ...
        <div className="skills__data">
          <div className="skills__titles">
            <h3 className="skills__name">Firebase Integration</h3>
            <span className="skills__number">90%</span>
          </div>
          <div className="skills__bar">
            <span className="skills__percentage skills__css3"></span>
        ...
        <div className="skills__data">
          <div className="skills__titles">
            <h3 className="skills__name">RoomDB & SQLite</h3>
            <span className="skills__number">80%</span>
          </div>
          <div className="skills__bar">
            <span className="skills__percentage skills__css3"></span>
